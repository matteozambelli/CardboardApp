...
In questo capitolo vengono riportari i classici diagrammi UML, i quali permettono tramite l'utilizzo di modelli visuali, di analizzare, descrivere, specificare e documentare un software, in sequenza di trovano package diagram (\ref{package}), component diagram (\ref{component}), class diagram (\ref{class}) e sequence diagram (\ref{sequence}).
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\columnwidth]{immagini/package_diagram}
...
\subsection{Dettaglio applicazione} //TODO
\newpage
\section{Class diagram}\label{class}
I class diagram sono stati semplificati per renderli leggibili in questo documento, sono stati tralasciati i campi e alcuni metodi.

\begin{figure}
	\centering
	\includegraphics[width=\columnwidth]{immagini/Activity_ridotto}
	\caption{Class diagram package Activity}
	\label{class_diagram_activity}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[width=\columnwidth]{immagini/DB_ridotto}
	\caption{Class diagram package DB}
	\label{class_diagram_db}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=\columnwidth]{immagini/Animation}
	\caption{Class diagram package Animation}
	\label{class_diagram_animation}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{immagini/serverClasses}
	\caption{Class diagram Server}
	\label{fig:serverClasses}
\end{figure}
