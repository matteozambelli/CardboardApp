...
public class PanoramaAsyncTask extends AsyncTask<Void, Void, Void> {
     ...
     * @param activity
     */
    public PanoramaAsyncTask(GlobalData globalData, ArrayList<ImageView> panoramaLeft1, ArrayList<ImageView> panoramaLeft2, ArrayList<ImageView> panoramaRight1, ArrayList<ImageView> panoramaRight2, ArrayList<ImageView> panoramaLeftSky, ArrayList<ImageView> panoramaRightSky, Activity activity) {
