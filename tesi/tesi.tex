...
\newpage
\subsection*{Reset}
L'utente può resettare la password premendo sul tasto \virgolette{forgot your password?}. Viene richiesta l'email e il colore preferito; se i dati superano la verifica sul database, viene generata random una nuova password alfanumerica di otto caratteri, che potrà poi successivamente essere personalizzata (vedi \ref{guida}). Verrà inoltre inviata una email come mostrato di seguito:
\begin{lstlisting}
	Hello dear **********@********!
	
	Your password has been changed and the new password is: d89j9g78. If you want customize your password, you can go over 'update your info'. Thanks for using our application, best regards.
