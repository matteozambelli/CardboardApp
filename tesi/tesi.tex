...
L'obiettivo di fondo era quello di un \textbf{upgrade} della tesi di laurea di primo livello, dove era stato fatto un restyling di un videogioco desktop, chiamato Space Invaders\footnote{http://3d4amb.unibg.it/software/spaceinvaders.it.html}. \\
...
Il fulcro di questa tesi è l'applicazione Car Racing Cardboard, nel corso di questo documento verrà analizzata a partire da un macro livello, focalizzandosi sull'idea che ha portato alla sua realizzazione, fino al livello di dettaglio implementativo degli algoritmi che la compongono.
%----------------------------------------------------------------------------------------
%	l'ambliopia
%----------------------------------------------------------------------------------------
