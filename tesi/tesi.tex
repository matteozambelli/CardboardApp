...
\thispagestyle{empty}
	\vspace{\fill}
	\begin{flushright}
		Ringraziamo il Professor Angelo Gargantini per i preziosi insegnamenti, Silvia Bonfanti per il supporto nella stesura di questo elaborato, inoltre vogliamo ringraziare le nostre famiglie per il sostegno ed il grande aiuto.\\ 
...
Per effettuare il log in vengono inviate al server email e password, che prima di essere inviata viene cifrata (vedi \ref{cifratura}).\\
