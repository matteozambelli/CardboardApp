...
\end{figure}
Da questa schermata è possibile effettuare il log in se l'utente è gia registrato, in caso contrario è possibile registrarsi premendo sul bottono \virgolette{SIGN UP}.
Prima della schermata di registrazione il sistema mostra un messaggio per ricordare all'utente (qualora esso non sia )
