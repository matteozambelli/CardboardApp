...
A questo punto inizia il gioco vero e proprio, l'utente può muovere la sua auto a sinistra premendo il tasto \virgolette{+} del controller e a destra premendo il tasto \virgolette{-} (Figura \ref{fig:game}).

La difficoltà aumenta dinamicamente, per rendere via via più stimolante il trattamento. Per ogni sessione di gioco un utente ha tre vite, dopo di che, una volta arrivati al \virgolette{game over}, l'applicazione chiede se si desidera ricevere via mail lo storico con i risultati.

//TODO--- inserire screen ultima schermata
...
\section{GitHub}Come repository del lavoro è stato utilizzato GitHub.
