...
\paragraph{Risultati promozione} sicuramente tale \virgolette{pubblicizzazione} ha infliuto nel numero di download dell'applicazione, possiamo notare un notevole picco dopo la data di rilascio, conseguentemente alla pubblicazione della pagina sui social: 
